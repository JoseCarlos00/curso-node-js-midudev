...
app.get('/movies', (req, res) => {
  ...
  //   // const respuesta = movies.filter((movie) => movie.genre.forEach(movi => console.log('Gen:', genero, 'Movi:', movi, '--', movi.includes(genero))));
  //   const inclu = genero.some(item => movies.forEach(peli => peli.genre.includes(item)));
  //   const respuesta = [];
  //   console.log('res', inclu);
